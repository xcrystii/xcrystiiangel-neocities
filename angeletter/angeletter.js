...
const GOOGLE_SHEET_ID = "1tTAq2B57nwI5WlWV6nStlrYGHQ0j0FNsExzKWf1JtyI";
...
const googleFormData = new FormData();
    googleFormData.append(ENTRY_ID, angeLetter);
    ...
    alert("Letter sent!!! Thank you for your submission ^^");
    location.reload();
  } catch (error) {
    console.error(error);
    statusText.textContent = "Error sending message :(";
    alert("Wuh oh ... the mail got lost to the web sea ... try again later !");
  } finally {
